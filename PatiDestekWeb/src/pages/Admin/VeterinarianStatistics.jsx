...
function VeterinarianStatistics() {
  ...
  return (
    <>
      <h2 className="mb-4 fw-bold">📊 İstatistikler</h2>
        ...
        <div className="col-lg-6 mb-4">
          <div className="card shadow h-100">
            ...
            >
              <Bar
                data={{
                  labels: (stats.animalTypes ?? []).map(
                    (x) => x.animal
                  ),
                  datasets: [
                    {
                      label: "İhbar Sayısı",
                      data: (stats.animalTypes ?? []).map(
                        (x) => x.count
                      ),
                      backgroundColor: [
                        "#198754",
...
export default VeterinarianStatistics;